...
class mistaketype_bo(models.Model):
    _name = 'mistaketype.bo'
    _description = 'Mistake Type Backoffice'
    _rec_name = 'name'
    _inherit = ['mail.thread', 'mail.activity.mixin']

    name = fields.Char(string='Mistake Type', required=True, track_visibility='always')
